# TySOM_2A_7Z030_pfm.tcl --
#
# This file uses the SDSoC Tcl Platform API to create the
# TySOM_2A_7Z030 hardware platform file
#
...
set pfm [sdsoc::create_pfm TySOM_2A_7Z030.hpfm]
sdsoc::pfm_name        $pfm "aldec.com" "xd" "TySOM_2A_7Z030" "1.0"
