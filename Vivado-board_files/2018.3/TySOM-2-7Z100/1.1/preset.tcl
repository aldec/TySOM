proc getPresetInfo {} {
  return [dict create name {TySOM-2-7Z100_preset} description {TySOM-2-7Z100_preset}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {TySOM-2-7Z100_preset} ]
}
